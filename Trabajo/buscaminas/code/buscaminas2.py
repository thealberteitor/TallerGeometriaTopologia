...
BLANCO = (255, 255, 100) # Pone blanco pero es amarillo claro jeje
NEGRO = (0 , 0 , 0)
AZUL = (0, 0, 255)
#GRIS= (190, 190, 190) #GRIS
GRIS = (255,255,255) # Pone gris pero es blanco jeje
VERDE = (0,187,45)
...
class Tablero:
    ...
    def __init__(self, ancho, alto, borde, numero_cuadros, n_minas):
        ...
        self.text = Text(FontSize=int(self.ancho_cuadro))
        #self.finJuego = False
            ...
            for j in range(self.numero_cuadros):
                ...
                if i!=0 and j!=0 and i!=self.numero_cuadros-1 and j!=self.numero_cuadros-1:
                    ...
                    if self.tablero[i][j]==' ':
                        ...
                        self.text.render(ventana, self.tablero[i][j], TEXTO, (aumento_ancho, aumento_alto))
...
def main():
    ...
    dim=int(sys.argv[1])*35

    dimensiones_tablero = [dim, dim]
    ...
    tablero = Tablero(dim, dim, 2, n, minas)
